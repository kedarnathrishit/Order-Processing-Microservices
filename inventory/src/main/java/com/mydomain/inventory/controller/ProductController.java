package com.mydomain.inventory.controller;
...
public class ProductController {
	...
	public ResponseEntity<Product> getProductById(@NotNull(message = "product id cannot be null") @PathVariable("id") Long id){
